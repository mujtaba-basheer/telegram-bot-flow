...
exports.getLoginDetails = exports.logout = exports.getToken = exports.getFreshToken = exports.authorizationUrl = void 0;
...
exports.authorizationUrl = (0, catch_async_1.default)(async (req, res) => {
    const { __ms, memberstack } = req.body;
    const baseUrl = "https://twitter.com/i/oauth2/authorize";
    try {
        const qs = await (0, auth_1.getAuthorizationParamsString)(scope_1.default, __ms, memberstack);
        res.json({
            status: true,
            data: baseUrl + "?" + qs,
        });
...
exports.getLoginDetails = (0, catch_async_1.default)(async (req, res, next) => {
    try {
        const { state } = req.params;
        const details = (0, auth_1.findLoginDetails)(state);
        if (details) {
            res.json({
                status: true,
                data: details,
            ...
            return next(new app_error_1.default("Login Details Not Found", 404));
    }
    catch (error) {
        return next(new app_error_1.default(error.message, 501));
    }
